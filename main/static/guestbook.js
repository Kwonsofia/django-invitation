var button = document.querySelector("#write-guestbook");
var modalContainer = document.querySelector("#guestbook-modal");
var closeModal = document.querySelector('#close-guestbook')
